          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <div class="art-avatar">
                <a data-fancybox="avatar" href="assets/img/face-3.png" class="art-avatar-curtain">
            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  <!-- country -->
                  <li>
                    <h6>Localisation:</h6><span>Guyane Française</span>
                  </li>
                  <!-- city -->
                  <li>
                  ...
                  <!-- age -->
                  <li>
                    <h6>Tel:</h6><span>0694 48 29 48</span>
                  </li>
                </ul>
              </div>
              <!-- info bar about end -->
              ...
              <div class="art-links-frame p-15-15">
                ...
                <!-- download cv button -->
                <a href="assets/files/cv.txt" class="art-link" download>Lis-moi.text <i class="fas fa-download"></i></a>
