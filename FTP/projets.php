...
<head>
  ...
  <title>RyzenCode: Sites réalisés</title>
</head>
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid">
                ...
                <div class="row p-30-0">
                  ...
                  <!-- Début de l'article -->
                  <?php
                                            require_once("articles/accueil/projets/includes/database.php");
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="art-a art-blog-card">
                      ...
                      <a href="/blog-post.html" class="art-port-cover">
                        <!-- img -->
                        <img src="https://ryzencode/articles/accueil/projets/assets/img/<?php echo $reponse->images_name; ?>"
                          alt="">
                      </a>
                      <!-- post cover end -->
                      <!-- post description -->
