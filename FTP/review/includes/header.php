...
<head>
  ...
  <title>RyzenCode: Avis Clients</title>
  <meta name="description" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="https://ryzencode/assets/images/icons/icon_logo2.png">
  ...
  <link rel="stylesheet" href="https://ryzencode/review/assets/css/style.css">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-primary bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand text-light" href="https://ryzencode/review/">RyzenCode</a>
